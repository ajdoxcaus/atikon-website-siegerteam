  ...
  return (
    <svg className="h-full w-full" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        >
          <path
            d="M0,0 L73,0 C73,0 73,13 84,24 C92,32 108,32 116,24 C127,13 127,0 127,0 L273,0 C273,0 273,-13 284,-24 C292,-32 308,-32 316,-24 C327,-13 327,0 327,0 L400,0"
            fill="none" stroke={c} strokeWidth={w}
          />
          <path
            d="M0,200 L73,200 C73,200 73,187 84,176 C92,168 108,168 116,176 C127,187 127,200 127,200 L273,200 C273,200 273,213 284,224 C292,232 308,232 316,224 C327,213 327,200 327,200 L400,200"
            fill="none" stroke={c} strokeWidth={w}
          />
          <path
            d="M0,0 L0,73 C0,73 13,73 24,84 C32,92 32,108 24,116 C13,127 0,127 0,127 L0,273 C0,273 -13,273 -24,284 C-32,292 -32,308 -24,316 C-13,327 0,327 0,327 L0,400"
            fill="none" stroke={c} strokeWidth={w}
          />
          <path
            d="M200,0 L200,73 C200,73 187,73 176,84 C168,92 168,108 176,116 C187,127 200,127 200,127 L200,273 C200,273 213,273 224,284 C232,292 232,308 224,316 C213,327 200,327 200,327 L200,400"
            fill="none" stroke={c} strokeWidth={w}
          />
        </pattern>
